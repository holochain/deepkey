...
pub fn validate_update_device_invite_acceptance(
    ...
    Ok(
        ValidateCallbackResult::Invalid(
            String::from("Device Invite Acceptances cannot be updated"),
        ),
    )
}
pub fn validate_delete_device_invite_acceptance(
    ...
    Ok(
        ValidateCallbackResult::Invalid(
            String::from("Device Invite Acceptances cannot be deleted"),
        ),
    )
}
...
pub fn validate_delete_link_device_invite_to_device_invite_acceptances(
    ...
    Ok(
        ValidateCallbackResult::Invalid(
            String::from("DeviceInviteToDeviceInviteAcceptances links cannot be deleted"),
        ),
    )
}
